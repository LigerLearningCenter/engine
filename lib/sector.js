class Sector {
    ...
    constructor(milestoneCoefficentLists, socialMood) {
    ...
    get isUnderinvested1() {
        return this.numberOfTurnsAfterLastInvestment = 1;
    }

    get isUnderinvested2() {
        return this.numberOfTurnsAfterLastInvestment >= 2;
    }
    ...
    /**
    * deduct investment to change milestone levell
    */
    calculateInvestment() {
        var numberOfMilestone = Math.floor(this.investment / 500);
        this.investment -= numberOfMilestone * 500;
        this.milestone.increaseLevel(numberOfMilestone);
    }
