class GameState {
  ...
  */
    ...
    checkSectorForUnbuitMilestone(sectorName) {
        this.effectiveness = this.sectors.effectiveness;
        this.investment = this.sectors[sectorName].investment;
        this.moneyLeft = this.investment % 500;
        this.sectors[sectorName].investment -= this.moneyLeft;
        this.budget += this.moneyLeft * this.effectiveness;
    }
